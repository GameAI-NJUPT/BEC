...
if __name__ == "__main__":
    ...
    path1 = "../results/cliff_walking/Q.npy"  # Q
    path2 = "../results/cliff_walking/GQ.npy"  # GQ
    path3 = "../results/cliff_walking/CQ.npy"  # CQ
    path4 = "../results/cliff_walking/CGQ.npy"  # CGQ
    ...
    plt.xlim(0, 3000)
    plt.legend()
    plt.savefig("../img/cliff_walking.pdf")
    plt.show()