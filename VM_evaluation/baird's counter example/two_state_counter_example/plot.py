...
if __name__ == "__main__":
    ...
    plt.ylabel("Root Mean Square Bellman Error")  # 设置轴字体及标签
    plt.xlabel("Training episodes")

    path1 = "../../../results/2state/TD.npy"  
    path2 = "../../../results/2state/CTD.npy"  
    path3 = "../../../results/2state/TDC.npy"  
    path4 = "../../../results/2state/CTDC.npy"  
    ...
    plt.plot(step1_sampled, smoothed1_sampled, label="TD", color="blue", linestyle='-', marker='s',
             markersize=10, linewidth=2)
    plt.fill_between(step1_sampled, mean1_sampled + std1_sampled, mean1_sampled - std1_sampled, color="blue", alpha=0.1)

    plt.plot(step2_sampled, smoothed2_sampled, label="CTD", color="green", linestyle='-', marker='^', markersize=10,
             linewidth=2)
    plt.fill_between(step2_sampled, mean2_sampled + std2_sampled, mean2_sampled - std2_sampled, color="green",
                     alpha=0.1)

    plt.plot(step3_sampled, smoothed3_sampled, label="TDC", color="red", linestyle='-', marker='D', markersize=10,
             linewidth=2)
    plt.fill_between(step3_sampled, mean3_sampled + std3_sampled, mean3_sampled - std3_sampled, color="red", alpha=0.1)

    plt.plot(step4_sampled, smoothed4_sampled, label="CTDC", color="black", linestyle='-', marker='p', markersize=10,
             linewidth=2)
